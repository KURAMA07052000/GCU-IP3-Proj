...
app.post('/register', async (req, res) => {
    ...
    try{
        if (docs==''){
        db.insert({  name: req.body.firstName,
            ...
            birthday_year: req.body.birthday_year}, function(err, newDoc){
            if(err) {
    ...
    console.log('Passwords are not the same');
        res.send("<div align ='center'><h2>Passwords are not the same</h2></div><br><br><div align='center'><a href='./SignUp.html'>SignUp</a></div><br><br><div align='center'><a href='./SignUp.html'>Register another user</a></div>");
}
});
});
